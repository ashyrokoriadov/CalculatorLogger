...
{
    class ExcludingBandResolverTests : BandResolverTests
    {
        protected override void InitializeSystemUnderTests(Dictionary<decimal, decimal> bands)
        {
            SystemUnderTests = new ExcludingBandResolver(ArithmeticValidatorMock, bands);
        }
        ...
        static readonly object[] BandValuesCaseSource =
        {
            ...
            new object[] { 0.0M, 0M, "Out of band range result" },
            new object[] {10000M, 1.25M, "Band resolution result" },
            ...
            new object[] {40000M, 3.50M, "Band resolution result" },
